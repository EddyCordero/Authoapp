...
namespace Authoapp.API.Repositories
{
    ...
    {
        protected readonly AuthoappDbContext Database;
        protected DbSet<T> DbSet => Database.Set<T>();

        protected BaseRepository(AuthoappDbContext database)
        {
            Database = database;
        }
        ...
        public IQueryable<T> GetAll() => DbSet.Where(x => x.DeletedAt == null);
